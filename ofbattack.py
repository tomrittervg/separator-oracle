...
def getExceptionType(ciphertext, verbosity=0):
	...
	oracle_server.request("GET", '/ofb/decrypt/' + ciphertext)
...
#one block
#aa|a|bbbccccdddd
valid_ciphertext = bytearray(b64decode("xbQplWbqZ7qeq/So+tNheg=="))
#two blocks
#aaaabbbbccccddddeeee|fffgggg|hhh (20, 28)
valid_ciphertext = bytearray(b64decode("xbQ0lXjqZ7qeq/So+tNheoJk1eHl1pMnulVuaSuKvTI="))
#aaaa|bbbccccddddeeeeffffgggg|hhh (4, 28)
valid_ciphertext = bytearray(b64decode("xbQ0lWbqZ7qeq/So+tNheoJk1eH/1pMnulVuaSuKvTI="))
#aaaa|bbbcccc|dddeeeeffffgggghhhh (4, 12)
valid_ciphertext = bytearray(b64decode("xbQ0lWbqZ7qeq/So4tNheoJk1eH/1pMnulVuaT+KvTI="))
#aaa|bbbbcccc|dddeeeeffffgggghhhh (3, 12)
valid_ciphertext = bytearray(b64decode("xbQ0iHjqZ7qeq/So4tNheoJk1eH/1pMnulVuaT+KvTI="))
