...
def getExceptionType(ciphertext, verbosity=0):
	...
	oracle_server.request("GET", '/ctr/decrypt/' + ciphertext)
...
#Less than 1 block
#aa|a|bbb
valid_ciphertext = bytearray(b64decode("/LqXAfeiXLc="))
#two blocks
#aaaabbbbccccddddeeee|fffgggg|hhh (20, 28)
#valid_ciphertext = bytearray(b64decode("/LqKAemiXLfq+Pz06eWhM858zsIJBDGmwp4ARR0aZE8="))
#aaaa|bbbccccddddeeeeffffgggg|hhh (4, 28)
#valid_ciphertext = bytearray(b64decode("/LqKAfeiXLfq+Pz06eWhM858zsITBDGmwp4ARR0aZE8="))
#aaaa|bbbcccc|dddeeeeffffgggghhhh (4, 12)
#valid_ciphertext = bytearray(b64decode("/LqKAfeiXLfq+Pz08eWhM858zsITBDGmwp4ARQkaZE8="))
#aaa|bbbbcccc|dddeeeeffffgggghhhh (3, 12)
#valid_ciphertext = bytearray(b64decode("/LqKHOmiXLfq+Pz08eWhM858zsITBDGmwp4ARQkaZE8="))
